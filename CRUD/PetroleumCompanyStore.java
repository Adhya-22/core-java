class PetroleumCompanyStore
{
	...
	{
		System.out.println("Executing update in PetroleumCompanyStore...");
	...
	{
		System.out.println("Executing update using element in PetroleumCompanyStore..");
		if(oldCompany!=null)
		{
			int index=0;
	...
	{
		System.out.println("Executing delete in PetroleumCompanyStore..");
		if(index>=0 && index<=this.companyNames.length-1)
		{
	...
	{
		System.out.println("Executing delete with company in PetroleumCompanyStore..");
		int index=0;
